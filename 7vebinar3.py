...
class PublicTransport:
    ...
    @property
    def info(self):
        return f"{self.brand}, {self.color}, {self.year}, {self._engine_power} hp"


class Bus(PublicTransport):
    def __init__(self, brand: str, engine_power: int, year: int, color: str, max_speed: int, passengers: int, park: int,
                 fare: int):
...
class Tram(PublicTransport):
    def __init__(self, brand: str, engine_power: int, year: int, color: str, max_speed: int, route: str, path: int,
                 fare: int):
        super().__init__(brand, engine_power, year, color, max_speed)
        self._route = route
        self.path = path
